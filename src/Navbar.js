                ...
                <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul className="navbar-nav menu-navbar-nav ">
                        ...
                        <li className="nav-item mt-3 mt-lg-0">
                            <a  href="/">
                                <button className="main-btn" style={{ color: props.mode === 'light' ? 'black' : '#c6c9d8bf', borderColor: props.mode === 'light' ? 'black' : '#c6c9d8bf' }} type="button" data-bs-toggle="offcanvas" data-bs-target="#Contact">Contact</button>  
                            </a>
                        </li>
                        <li className="pt-2">
